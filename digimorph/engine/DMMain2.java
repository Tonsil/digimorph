...
public class DMMain2 extends JApplet {
	...
	public void setOsc1Tuning(double t) {
		osc1.setTuning(t);
	}
	...
	public void setOsc2Tuning(double t) {
		osc2.setTuning(t);
	}
	...
	public void playScale() {
		...
		osc2.frequency.set(262.0, now_time);
		now_time += step_time;
		
		osc1.frequency.set(294.0, now_time);
		osc2.frequency.set(294.0, now_time);
		now_time += step_time;

		osc1.frequency.set(330.0, now_time);
		osc2.frequency.set(330.0, now_time);
		now_time += step_time;

		osc1.frequency.set(349.0, now_time);
		osc2.frequency.set(349.0, now_time);
		now_time += step_time;
		...
		osc2.frequency.set(440.0, now_time);
		now_time += step_time;

		osc1.frequency.set(493.0, now_time);
		osc2.frequency.set(493.0, now_time);
		now_time += step_time;

		osc1.frequency.set(523.0, now_time);
		osc2.frequency.set(523.0, now_time);
		now_time += step_time;
	}
}
